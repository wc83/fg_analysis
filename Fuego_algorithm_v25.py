...
scan_start = UTCDateTime(2018,3,14,0,0,0).timestamp - 600
days = 800

Station_info = np.zeros(shape=(days,5))

for x in range(413,days):    
...
np.savetxt("/Users/william/Documents/Fuego_catalogue/Fuego_Full_scan_v5.csv", final_ordered,delimiter=",",header="Time_stamp,Year,Month,Day,Hour,Min,Sec,Event_type_ID,Duration [s],#inf,#seis,#Stations,VF01,VF02,VF03,VF04,VF05,VF06,FG8A,FG8B,FG8C,FG10A,FG10B,FG10C,FG11A,FG11B,FG11C,FG11D,FG12A,FG12B,FG12C,FG13A,FG13B,FG13C,FG15A,FG15B,FG15C,FG15D,FG15E,FG15F,FV01,FV02,FV03,FV04,FV08,FG3S,FG8S,FG10S,FG11S,FG12S,FG13S,FG14S,FG16S")

np.savetxt("/Users/william/Documents/Fuego_catalogue/Fuego_Full_scan_v5_stations.csv", Station_info,delimiter=",",header="Day_no,Time_stamp,Inf,Seis,All")
