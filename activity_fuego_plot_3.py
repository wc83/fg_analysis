...
for x in range(0,len(FG3s_ac),2):
        ax.broken_barh([(FG3s_ac[x]*(60*60*24)+1520640000, FG3s_ac[x+1]*(60*60*24))], (1, 4), facecolors='k')
for x in range(0,len(FG8s_ac),2):
        ax.broken_barh([(FG8s_ac[x]*(60*60*24)+1520640000, FG8s_ac[x+1]*(60*60*24))], (6, 4), facecolors='k')
for x in range(0,len(FG10s_ac),2):
        ax.broken_barh([(FG10s_ac[x]*(60*60*24)+1520640000, FG10s_ac[x+1]*(60*60*24))], (11,4), facecolors='k')
for x in range(0,len(FG11s_ac),2):
        ax.broken_barh([(FG11s_ac[x]*(60*60*24)+1520640000, FG11s_ac[x+1]*(60*60*24))], (16,4), facecolors='k')
for x in range(0,len(FG12s_ac),2):
        ax.broken_barh([(FG12s_ac[x]*(60*60*24)+1520640000, FG12s_ac[x+1]*(60*60*24))], (21,4), facecolors='k')
for x in range(0,len(FG13s_ac),2):
        ax.broken_barh([(FG13s_ac[x]*(60*60*24)+1520640000, FG13s_ac[x+1]*(60*60*24))], (26,4), facecolors='k')
for x in range(0,len(FG14s_ac),2):
        ax.broken_barh([(FG14s_ac[x]*(60*60*24)+1520640000, FG14s_ac[x+1]*(60*60*24))], (31,4), facecolors='k') 
for x in range(0,len(FG14s_ac),2):
        ax.broken_barh([(FG14s_ac[x]*(60*60*24)+1520640000, FG14s_ac[x+1]*(60*60*24))], (36,4), facecolors='k') 
...
fig, ax = plt.subplots(figsize=(8,5))    
ax.plot(day,numa,'b--',label='Inf')        
ax.plot(day,nums,'r--',label='Seis')        
#ax.plot(day,num_all,'k-',label='Both')         
ax.set_ylim(0, 20)      
ax.set_xlim(0, 820)  
ax.legend()   
ax.set_ylabel('Number of Stations [#]')
